        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LongTermGoals_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainDailyGoals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainDailyGoals_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalMilestones_LongTermGoals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalTasks_LongTermGoals_GoalId",
                        column: x => x.GoalId,
                        principalTable: "LongTermGoals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CalendarEvents_UserId_StartDate_EndDate",
                table: "CalendarEvents",
                columns: new[] { "UserId", "StartDate", "EndDate" });

            migrationBuilder.CreateIndex(
                name: "IX_DailyTasks_UserId_Date",
                table: "DailyTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MainDailyGoals_UserId_Date",
                table: "MainDailyGoals",
                columns: new[] { "UserId", "Date" },
                unique: true);
