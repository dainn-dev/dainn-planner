...
namespace DailyPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260320101533_AddRepeatTask")]
    partial class AddRepeatTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.RepeatTask", b =>
                {
                    ...
                    b.HasKey("TaskId", "RepeatDate");

                    b.ToTable("RepeatTask");
                });
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.RepeatTask", b =>
                {
                    b.HasOne("DailyPlanner.Domain.Entities.DailyTask", "DailyTask")
                        .WithMany("RepeatTasks")
