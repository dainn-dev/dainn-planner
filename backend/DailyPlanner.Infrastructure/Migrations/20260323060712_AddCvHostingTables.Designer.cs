...
namespace DailyPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260323060712_AddCvHostingTables")]
    partial class AddCvHostingTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.CvAppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("cv_app_notifications", (string)null);
                });
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.CvSite", b =>
                {
                    ...
                    b.ToTable("cv_sites", (string)null);
                });
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.TaskInstance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.UserStatistics", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("GoalsMilestonesCompleted")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.TaskInstance", b =>
                {
                    b.HasOne("DailyPlanner.Domain.Entities.DailyTask", "Task")
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("CvAppNotifications");
