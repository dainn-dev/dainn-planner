...
namespace DailyPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260404000000_AddTaskInstanceStartEndTime")]
    partial class AddTaskInstanceStartEndTime
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.CalendarEvent", b =>
                {
                    ...
                    b.Property<string>("ProjectTagsJson")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("DailyPlanner.Domain.Entities.UserPushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
